...
(function($) {
 ...
 const collapse3 = document.querySelector('#collapse3');

 const btn1 = document.querySelector('[data-target="#collapse1"]');
 const btn2 = document.querySelector('[data-target="#collapse2"]');
 const btn3 = document.querySelector('[data-target="#collapse3"]');
